## Лабораторна робота №8 з дисципліни "Алгоритмізація та програмування, ч.2"
...
**Файли**
- lab8 - основне завдання
- lab8_add.py - реалізація з використанням heap
- islands.txt - файл з графом
